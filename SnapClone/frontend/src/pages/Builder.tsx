...
// Helper function to create mount structure for WebContainer
...
export function Builder() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col">
      {(webcontainerError || mountError) && (
        <div className="bg-red-900/50 p-4 text-red-100">
          <p>WebContainer Error: {webcontainerError || mountError}</p>
          <p className="text-sm mt-1">
            Preview functionality may be limited. Please try the following:
            <ul className="list-disc ml-6 mt-2">
              <li>Use a Chromium-based browser (Chrome, Edge, etc.)</li>
              <li>Close any other tabs running this application</li>
              <li>Clear your browser cache and refresh the page</li>
              <li>If the error persists, restart your browser</li>
            </ul>
          </p>
        </div>
      )}
